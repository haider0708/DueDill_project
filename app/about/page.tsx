              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm mt-2">
                    Former fintech executive with 15+ years of experience in financial markets and blockchain
                    technology.
                  </p>
                </div>
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm mt-2">
                    Blockchain developer and architect who has contributed to several major cryptocurrency projects.
                  </p>
                </div>
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm mt-2">
                    Former cryptocurrency analyst with expertise in tokenomics and fundamental analysis.
                  </p>
                </div>
              </div>
            </CardContent>
