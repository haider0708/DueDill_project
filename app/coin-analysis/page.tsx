                ...
                <div className="space-y-6">
                  ...
                  <div className="p-4 border border-yellow-200 bg-yellow-50 rounded-lg">
                    <p className="text-sm text-yellow-700">
                      <strong>Disclaimer:</strong> These predictions are based on historical data analysis and should
                      not be considered as financial advice. Cryptocurrency markets are highly volatile and
                      unpredictable.
                    </p>
                  </div>
                </div>
          ...
          <Card className="bg-white border-gray-200 text-gray-800">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Raw News Data for {selectedCoin.symbol?.toUpperCase()}
              </CardTitle>
